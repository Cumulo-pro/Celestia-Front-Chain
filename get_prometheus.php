...
case $net=="blockspacerace";
	$data = file_get_contents("http://74.208.94.42:26660");
	$ch="blockspacerace-0";
break;
case $net=="mocha";
	$data = file_get_contents("http://54.39.128.229:26660");
	$ch="mocha";
break;
}
...
case $pide=="block_time":
  preg_match('|tendermint_consensus_block_interval_seconds_sum{chain_id="'.$ch.'"}(.*?)# HELP|is' , $data , $cap );
  $sal=$cap[1];
