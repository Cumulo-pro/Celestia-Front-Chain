...
<?php
//error_reporting(0);
$rpc ="https://celestia.cumulo.org.es"; //default value
header('Content-Type: text/html; charset=utf-8');
//choose chain
switch($net=$_REQUEST['chain']){
case $net=="blockspacerace";
	$rpc = "https://celestia.cumulo.org.es";
break;
case $net=="mocha";
	$rpc = "http://54.39.128.229:26657";
break;
}
...
break;
case $pide=="get_token":
$data_json = file_get_contents('https://celestia.cumulo.org.es/genesis?');
$json = json_decode($data_json);
$allData=$json->result;
